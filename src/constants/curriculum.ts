...
export const INITIAL_VIRTUAL_COMPETITIONS = [
  {
    id: 'vc_01',
    title: 'Autonomous Maze Navigation Simulation Sprint',
    category: 'robot_simulation',
    category_label: 'Robot Simulation',
    description: 'Design and code a differential drive robot in Wokwi/Tinkercad to solve a complex maze with variable corridors and dynamic obstacles in under 60 seconds.',
    rules: '1. Solution must use non-blocking millis() logic.\n2. Must handle dead ends with reverse-and-scan algorithm.\n3. Submit public Wokwi simulation URL + short video walkthrough.',
    starter_url: 'https://wokwi.com/projects/new/arduino-uno',
    duration_hours: 48,
    max_score: 100,
    status: 'active',
    prize: 'USD $100 Cash Prize + YARIA Gold Innovation Badge',
    image_url: 'https://images.unsplash.com/photo-1485827404703-89b55fcc595e?auto=format&fit=crop&w=800&q=80',
    criteria: [
      'Algorithm efficiency and maze completion time (40%)',
      'Non-blocking C++ code quality and structure (30%)',
      'Deadlock and corner collision avoidance (20%)',
      'Documentation and explanation write-up (10%)'
    ]
  },
  {
    id: 'vc_02',
    title: 'Compact Robotics Power & Sensor PCB Design Challenge',
    category: 'pcb_design',
    category_label: 'PCB Design',
    description: 'Design a 2-layer custom motherboard PCB in EasyEDA or KiCad integrating an ATmega328P / ESP32, dual L9110S/L298N motor drivers, 5V switching buck regulator, and 4 sensor headers within a 60mm × 60mm footprint.',
    rules: '1. Minimum trace width 12 mil for signal, 30 mil for motor power rails.\n2. Ground plane copper pour on top and bottom.\n3. Submit EasyEDA/KiCad public project link or Gerber ZIP file.',
    starter_url: 'https://easyeda.com/',
    duration_hours: 72,
    max_score: 100,
    status: 'active',
    prize: 'Free PCB Fabrication Sponsorship + YARIA Hardware Certificate',
    image_url: 'https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=800&q=80',
    criteria: [
      'Thermal relief & high-current power trace routing (35%)',
      'Component layout compactness & ergonomics (25%)',
      'Design Rules Check (DRC) zero-error compliance (25%)',
      'BOM and 3D rendering preview (15%)'
    ]
  },
  {
    id: 'vc_03',
    title: 'Smart Agro-Robotics IoT Telemetry Logic Sprint',
    category: 'iot_automation',
    category_label: 'IoT Automation',
    description: 'Build an autonomous agricultural telemetry node that aggregates soil moisture, ambient humidity, and sunlight levels to automatically control irrigation valves and publish MQTT telemetry packets.',
    rules: '1. Program must simulate low-power sleep modes.\n2. Include LCD/OLED visualization and threshold alarm states.\n3. Submit simulation URL and source code.',
    starter_url: 'https://wokwi.com/',
    duration_hours: 24,
    max_score: 100,
    status: 'upcoming',
    prize: 'IoT Development Kit + Mentorship Fast-Track',
    image_url: 'https://images.unsplash.com/photo-1581092160607-ee22621dd758?auto=format&fit=crop&w=800&q=80',
    criteria: [
      'Multi-sensor aggregation accuracy (30%)',
      'Automatic actuator control logic (30%)',
      'Power efficiency & telemetry encoding (25%)',
      'Code cleanliness & comments (15%)'
    ]
  }
];
