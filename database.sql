...
-- =========================================================================
-- 13.5 ORGANIZATION POSTS & MULTI-CHANNEL BROADCAST ENGINE
-- =========================================================================
CREATE TABLE IF NOT EXISTS public.organization_posts (
  ...
  broadcast_status TEXT DEFAULT 'draft',
...
ALTER TABLE public.organization_posts ADD COLUMN IF NOT EXISTS is_breaking BOOLEAN DEFAULT false;
...
-- =========================================================================
-- 23. ORGANIZATION POSTS & MULTI-CHANNEL BROADCAST ENGINE (Defined in section 13.5)
-- =========================================================================
